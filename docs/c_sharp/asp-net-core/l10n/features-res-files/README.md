...
А вот ресурсник по умолчанию будет выбран для культуры **en**, также он будет выбран для культуры **fr** или вообще для любой другой культуры, отличной от **ru**, **de**, **es**.
...
2. Также в имени файла необходимо указать [культуру](https://learn.microsoft.com/ru-ru/aspnet/core/fundamentals/localization#language-and-countryregion-codes)
...
Раздельное редактирование может привести к ситуации, когда в одном ресурснике ключ локализации есть, а в другом он отсутствует.
