...
**Функциональная область видимости** – для любой функции `function(arg1, arg2, ...) {..}` все переменные и функций объявленных внутри блока `{..}`, а также ее аргументы попадают в функциональную области видимости и недоступны за ее границей.  
