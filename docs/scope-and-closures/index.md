...
**Функциональная область видимости** – для любой функции `function(arg1, arg2, ...) {..}` все переменные и функций объявленные внутри блока `{..}` + ее аргументы попадают в функциональную области видимости и недоступны за границей этой функции.  
