...
|    | Типы значений                             |                                                                                                        |
|----|-------------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1. | [Undefined](https://tinyurl.com/3mbrhdbk) | Значением `undefined` инициализируются те переменные, которые явно не проинициализированы.<br>Значение `undefined` возвращает функция, для котрой не определено return значение.<br>Значение `undefined` может иметь поле, которого нет в объекте.<br>[Не примитив И не объект](https://tinyurl.com/4586tj84) | 
