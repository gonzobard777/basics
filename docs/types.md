...
| boolean   | –                                                           | `1`/`0`                                                                                           | `1n`/`0n`                                      | `"true"/"false"`                                                                                   | [new&nbspBoolean(value)](https://tinyurl.com/4ferbkt5) |
...
| bigInt    | `0n` ? `false` : `true`                                     | TypeError / number                                                                                | –                                              | [BigInt::toString](https://tinyurl.com/m6zhrvre)                                                   | [`new BigInt(value)`](https://tinyurl.com/2zr4dpsa)  |
