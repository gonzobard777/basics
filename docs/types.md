...
|-------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|
| `Boolean(value)` or `!!`<br>`!`<br>`if`, циклы<br>`? :`<br>`&&`, `\|\|` | Unary `+`<br>`Number(value)`, Unary `-`, `~`<br>[Binary](https://tinyurl.com/b7ny87t9) `+`, `-`, `**`, `*`, `/`, `%`, `<<`, `>>`, `>>>`, `&`, `^`, `\|`<br>`==` | `String(value)`<br>`${value}`<br>`object[key]`, `in`<br>[Binary](https://tinyurl.com/b7ny87t9) `+` |
