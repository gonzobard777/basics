...
|    | Типы значений                             |                                                                                                        |
|----|-------------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1. | [Undefined](https://tinyurl.com/3mbrhdbk) | Значение `undefined` движек присваивает тем переменным, которые не определил программист.<br>Значение `undefined` возвращает функция, для котрой программист не определил значение return. [Не примитив И не объект](https://tinyurl.com/4586tj84) | 
