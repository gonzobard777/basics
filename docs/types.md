...
| String    | length === 0 ? `false` : `true`                             | [StringToNumber](https://tinyurl.com/v237tfs7),<br/> [parseInt](https://tinyurl.com/u7954aub),<br/> [parseFloat](https://tinyurl.com/h95bvjzh) | [StringToBigInt](https://tinyurl.com/27hu7bfu) | -                                                | [`new String(value)`](https://tinyurl.com/x92yace8)  |
