...
| 4. | [Number](https://tinyurl.com/dsz6yry7)    | [Числа](https://learn.javascript.ru/number), [Double-precision floating-point format](https://en.wikipedia.org/wiki/Double-precision_floating-point_format) | 
...
### Когда и как движёк выполнит конвертацию?
...
### Во что сконвертируется значение соответствующего типа?
