...
|    | Типы значений                             |                                                                                                        |
|----|-------------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1. | [Undefined](https://tinyurl.com/3mbrhdbk) | Значением `undefined` инициализируются те переменные, которые не проинициализировал программист.<br>Значение `undefined` возвращает функция, для котрой программист не определил return значение.<br>Значение `undefined` может иметь поле, которого нет в объекте.<br>[Не примитив И не объект](https://tinyurl.com/4586tj84) | 
