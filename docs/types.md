...
| Number    | `0` &#124;&#124; `NaN` ? `false` : `true`                                             | -                                                                                               | TypeError or [NumberToBigInt](https://tc39.es/ecma262/multipage/numbers-and-dates.html#sec-numbertobigint) | [Number::toString](https://tc39.es/ecma262/multipage/ecmascript-data-types-and-values.html#sec-numeric-types-number-tostring) | `Number(value)`                                                                     |
