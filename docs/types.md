...
|    | Типы значений                             |                                                                                                                                                                                                                                                                                                                                                                                                   |
|----|-------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1. | [undefined](https://tinyurl.com/3mbrhdbk) | Значение `undefined` имеет непроинициализированная переменная.<br>Значение `undefined` возвращает функция, для которой не определено return значение, [метод [[Call]]](https://tinyurl.com/5yjn9p8s).<br>Значение `undefined` возвращается при обращении к отсутствующему полю объекта, [метод [[Get]]](https://tinyurl.com/bdbacsk8).<br>[Не примитив И не объект](https://tinyurl.com/4586tj84) |
