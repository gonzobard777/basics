### Типы
1. [Undefined](https://262.ecma-international.org/12.0/#sec-ecmascript-language-types-undefined-type)
...
### Конвертация типов
[Type Conversion](https://262.ecma-international.org/12.0/#sec-type-conversion)
