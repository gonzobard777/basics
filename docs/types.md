...
|    | Типы значений                             |                                                                                                                                                                                                                                                                                                                                                                                                             |
|----|-------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1. | [undefined](https://tinyurl.com/3mbrhdbk) | Значение `undefined` присваивается непроинициализированным переменным.<br>Значение `undefined` возвращает функция, для которой не определено return значение ([метод](https://tinyurl.com/5yjn9p8s) [[Call]]).<br>Значение `undefined` возвращается при обращении к отсутствующему полю объекта ([метод](https://tinyurl.com/bdbacsk8) [[Get]]).<br>[Не примитив И не объект](https://tinyurl.com/4586tj84) |
